...
$SourceDir = Join-Path $pluginsDir "TamedIslandRestorationPlugin"
...
$outDll = Join-Path $pluginDir "TamedIslandRestorationPlugin.dll"
...
$refs = @(
    ...
    (Join-Path $pluginDir "HarborSailingMapPlugin.dll")
)
