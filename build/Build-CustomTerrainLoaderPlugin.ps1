...
$SourcePath = Join-Path $pluginsDir "CustomTerrainLoaderPlugin\CustomTerrainLoaderPlugin.cs"
...
$outDll = Join-Path $pluginDir "CustomTerrainLoaderPlugin.dll"
...
$refs = @(
    ...
    (Join-Path $refsDir "ICSharpCode.SharpZipLib.dll")
)
