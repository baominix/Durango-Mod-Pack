...
$SourceDir = Join-Path $pluginsDir "TitleBarMenuDisablePlugin"
...
$outDll = Join-Path $pluginDir "TitleBarMenuDisablePlugin.dll"
$csc = "C:\Windows\Microsoft.NET\Framework\v3.5\csc.exe"
$sources = @(Get-ChildItem -LiteralPath $SourceDir -Filter "*.cs" -File |
